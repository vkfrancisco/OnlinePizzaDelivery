      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Pizza Bites</span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Connect With Us </h2><p><a href="https://github.com/vkfrancisco" target="_blank">@vkfrancisco</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Pizza Bites</strong></h3>
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="row" style="padding-left: 228px;">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="">
            <div class="member">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/vk.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Vann Khryss Francisco</h4>
                </div>
                <div class="social">
                  <a href=""><i class="icofont-facebook" target="_blank"></i></a>
                  <a href="https://github.com/vkfrancisco" target="_blank"><i class="fab fa-github"></i></a>
                  <a href=""><i class="icofont-instagram" target="_blank"></i></a>
                </div>
              </div>
            </div>
          </div>
